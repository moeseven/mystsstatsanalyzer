...
@JsonProperty("current_upgrade_level")
private Integer currentUpgradeLevel;	
...
@JsonProperty("current_upgrade_level")
public Integer getCurrentUpgradeLevel() {
return currentUpgradeLevel;
}

@JsonProperty("current_upgrade_level")
public void setCurrentUpgrdeLevel(Integer currentUpgradeLevel) {
